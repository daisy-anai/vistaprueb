...
let ReporteCromaticaComponent = class ReporteCromaticaComponent {
    constructor() { }
    ngOnInit() {
    }
    generarpdf() {
...
ReporteCromaticaComponent = tslib_1.__decorate([
    Component({
...
export { ReporteCromaticaComponent };
