...
let ReporteFinalCromaticaComponent = class ReporteFinalCromaticaComponent {
    constructor() { }
    ngOnInit() {
    }
    generarpdf() {
...
ReporteFinalCromaticaComponent = tslib_1.__decorate([
    Component({
...
export { ReporteFinalCromaticaComponent };
